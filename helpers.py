...
def display_world(world_size, position, landmarks=None):
    ...
    :param world_size: the dimensions of the square grid representing the world the robot is in
    :param position: the position of the robot in the world
    :param landmarks: a list of landmark positions(an optional argument)
    """
...
def make_data(N, num_landmarks, world_size, measurement_range, motion_noise, measurement_noise, distance):
    ...
    :return: a list of measurements and movements: [measurements, [dx, dy]] collected over a specified number of time steps, N
    """
